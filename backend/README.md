...
## Project Structure
    ...
    ├── testapiautoteammemb_59712  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_59712`
...
2. Clone this repo and `cd testapiautoteammemb_59712`
